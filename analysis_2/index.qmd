...
5) Statistical analysis (Correlation Coefficient, Standard Error, & P-Value) of demographic variables 
and presence of post-secondary school buildings per census tract.  

6) Creation of  correlation heatmap with hvplot with a touchtip that shows the correlation, standard error, and p-value
